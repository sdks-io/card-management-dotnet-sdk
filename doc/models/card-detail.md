...
| `CardContact` | [`CardDeliveryContact`](../../doc/models/card-delivery-contact.md) | Optional | Request entity object for CardDeliveryContact<br>Mandatory when CardDeliveryType is 2 else ignored. |
...
| `PINContact` | [`PINDeliveryContact`](../../doc/models/pin-delivery-contact.md) | Optional | Request entity object for PINDeliveryContact<br>Mandatory when PINDeliveryAddressType is ‘3’ (New delivery address). Else, ignored. |
