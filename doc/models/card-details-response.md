...
| `StatusId` | [`CardDetailsResponseStatusIdEnum?`](../../doc/models/card-details-response-status-id-enum.md) | Optional | - |
...
| `PINType` | [`CardDetailsResponsePINTypeEnum?`](../../doc/models/card-details-response-pin-type-enum.md) | Optional | - |
...
| `InternationalPOSLanguageID` | [`CardDetailsResponseInternationalPOSLanguageIDEnum?`](../../doc/models/card-details-response-international-pos-language-id-enum.md) | Optional | - |
| `InternationalPOSLanguageCode` | [`CardDetailsResponseInternationalPOSLanguageCodeEnum?`](../../doc/models/card-details-response-international-pos-language-code-enum.md) | Optional | - |
| `LocalPOSLanguageID` | [`CardDetailsResponseInternationalPOSLanguageIDEnum?`](../../doc/models/card-details-response-international-pos-language-id-enum.md) | Optional | - |
| `LocalPOSLanguageCode` | [`CardDetailsResponseInternationalPOSLanguageCodeEnum?`](../../doc/models/card-details-response-international-pos-language-code-enum.md) | Optional | - |
...
| `RenewedCardReissueSetting` | [`CardDetailsResponseRenewedCardReissueSettingEnum?`](../../doc/models/card-details-response-renewed-card-reissue-setting-enum.md) | Optional | - |
