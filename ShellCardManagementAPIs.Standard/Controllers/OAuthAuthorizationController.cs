...
namespace ShellCardManagementAPIs.Standard.Controllers
{
    ...
    public class OAuthAuthorizationController : BaseController
    {
        ...
        public Models.OAuthToken RequestTokenBearerToken(
                string authorization,
                string scope = null,
                Dictionary<string, object> fieldParameters = null)
            => CoreHelper.RunTask(RequestTokenBearerTokenAsync(authorization, scope, fieldParameters));
        ...
        /// <returns>Returns the Models.OAuthToken response from the API call.</returns>
        public async Task<Models.OAuthToken> RequestTokenBearerTokenAsync(
                string authorization,
                string scope = null,
                Dictionary<string, object> fieldParameters = null,
